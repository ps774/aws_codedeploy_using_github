<?php
	...
	$_GET['message'] = preg_replace("/[^A-Za-z0-9 \:\.]/", "", $_GET['message'] );
?>
<html>
<head>
...
<body class="m-3" style="background: #FFFFFF;">
	<a href="/<?php echo $base;?>index.php"><img src="/<?php echo $base;?>img/popsixle_logo2.png" width="205" height="52" style="margin:0 0 10px;" alt="Popsixle Logo" border="0" /></a>
		...
		<div class="container-fluid" style="">
			<div class="card text-center" style="margin: 1.25rem 0px;">
				<div class="card-body">
					<h4 style="margin:50px 0px;">Sorry, something went wrong.</h4>
					<p class="card-text" style="margin:50px 0px;color:red;"><b>Error Message:</b> <?php echo($_GET['message']);?></p>
				</div>
			</div>
		</div>
	</body>
