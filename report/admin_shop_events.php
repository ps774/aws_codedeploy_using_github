...
<body class="m-3" style="background: #FFFFFF;">
	...
	?>
			...
			<div class="card base-card bg-light border p-3">
				...
				<form id="event" action="/<?php echo $base;?>admin_shop_events.php?shop=<?php echo $_GET["shop"];?>" method="post" autocomplete="off">					
			...
			*/
			...
			function delete_event(id){
				...
				$.post( "/<?php echo $base;?>pop6_ping.php", args, function( data ) {
					...
					window.location.href = '/'+base+'admin_shop_events.php/?shop=<?php echo $_GET["shop"];?>';
